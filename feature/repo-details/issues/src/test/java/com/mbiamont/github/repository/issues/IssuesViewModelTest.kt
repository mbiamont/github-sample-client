...
class IssuesViewModelTest : KoinTest {
    ...
    @Test
    fun displayIssueList() {
        val viewState = listOf(issueViewState)

        viewModel.displayIssueList(viewState)


        assertEquals(viewState, viewModel.issuesListLiveData.value)
    }
    ...
    private companion object {
        ...
        val issueViewState = IssueViewState(
